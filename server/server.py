...
def update_timestamp(conn, key, ts_name):
    """
...
def activate_licence(conn, key, hash):
    """
...
def check_license(license_hash, key):
    ...
    # all checks are OK
    update_timestamp(conn, key, "checked_ok_on")
    return True
